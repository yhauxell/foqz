...
export function WorkspaceSidebar({
  ...
  return (
    <aside
      className="glass-panel pointer-events-auto backdrop-blur-xl backdrop-saturate-150 absolute top-3 bottom-3 left-3 w-80 max-w-[calc(100vw-2rem)] rounded-[24px] flex flex-col text-zinc-900 dark:text-zinc-100 font-sans select-none z-[5900] animate-in slide-in-from-left-4 duration-200 overflow-hidden"
